        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-[#363636]'>
                    ...
                    <p className='text-emerald-600'>{userData.email}</p>
                    ...
                    {isEdit
                        ...
                        : <p className='text-emerald-600'>{userData.phone}</p>
                    }
            ...
            <div className='mt-10'>
                ...
                {isEdit
                    ? <button onClick={updateUserProfileData} className='border border-emerald-500 px-8 py-2 rounded-full hover:bg-emerald-500 hover:text-white transition-all'>Save information</button>
                    : <button onClick={() => setIsEdit(true)} className='border border-emerald-500 px-8 py-2 rounded-full hover:bg-emerald-500 hover:text-white transition-all'>Edit</button>
                }
